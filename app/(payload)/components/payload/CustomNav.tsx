...
const NavItem: React.FC<NavItemProps> = ({ href, icon, label, isActive, isSubItem = false }) => {
    return (
        <Link
            href={href}
            style={{
        ...
        >
            <span style={{ display: 'flex', alignItems: 'center', flexShrink: 0, width: '1rem', height: '1rem' }}>{icon}</span>
            <span>{label}</span>
        </Link>
    );
};
        ...
        >
            ...
            >
                <Link href="/admin" style={{ opacity: 0.8 }}>
                    <Image src={logo} alt="Logo" width={100} height={32} style={{ display: 'block', filter: 'invert(1)' }} />
                </Link>
            </div>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '0.75rem 0' }}>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    {/* Prayer Times */}
                    <NavItem
                        href="/admin/collections/prayer-times"
                        icon={
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" style={iconStyle}>
                        ...
                        label="Prayer Times"
                        isActive={pathname === '/admin/collections/prayer-times'}
                    />
