...
interface CommitteesSectionProps {
  ...
  className?: string;
  headerStyle?: string;
  committesStyle?: string;
}

export function CommitteesSection({ title, description, members, className, headerStyle, committesStyle }: CommitteesSectionProps) {
  if (!members || members.length === 0) return null;
  return (
    <section className={`w-full bg-white py-16 sm:py-20 md:py-24 lg:py-28 xl:py-33 ${className}`}>
