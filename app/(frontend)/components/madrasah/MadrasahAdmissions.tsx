...
export default function MadrasahAdmissions({ data }: MadrasahAdmissionsProps) {
                ...
                <div className="adm-cards">
                    ...
                    <div className="adm-card">
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{ __html: data.eligibilityBody.replace(/\n\n/g, '<br/><br/>').replace(/\n/g, '<br/>') }}
                        />
                    </div>
                    ...
                    <div className="adm-card">
                        ...
                        <div
                            className="adm-card-body"
                            dangerouslySetInnerHTML={{ __html: data.processBody.replace(/\n\n/g, '<br/><br/>').replace(/\n/g, '<br/>') }}
                        />
                    </div>
                    ...
                    <div className="adm-card-featured">
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{ __html: data.feesBody.replace(/\n/g, '<br/>') }}
                        />
                        ...
                        {/* CTA */}
                        <Link href={data.feesCtaUrl || '#'} className="adm-cta-btn">
                            <span className="adm-cta-btn-text">{data.feesCtaText}</span>
                        </Link>
                    </div>
                </div>
            </div>
