            ...
            <div className="section-padding journey-inner z-2 relative">
                <div className="journey-content">
                    ...
                    <div className="journey-buttons">
                        <Link href={data.primaryButtonUrl || '#'} className="journey-btn journey-btn-primary">
                            <div className="journey-btn-shadow" />
                            <span className="journey-btn-primary-text">{data.primaryButtonText}</span>
                        </Link>

                        <Link href={data.secondaryButtonUrl || '#'} className="journey-btn journey-btn-secondary">
                            <span className="journey-btn-secondary-text">{data.secondaryButtonText}</span>
                        </Link>
                    </div>
                </div>
            </div>
