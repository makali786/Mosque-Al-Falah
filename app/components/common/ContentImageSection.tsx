    ...
    >
      <div>
        <div
          ...
          } gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-start`}
        >
          {/* Text Content */}
          ...
          <div className="flex-1 w-full">
            <div
              className={`relative w-full aspect-[16/9] sm:aspect-[4/3] ${
                imageStyle === "rounded" ? "rounded-xl overflow-hidden" : ""
              }`}
            >
              <Image
                src={imageSrc}
